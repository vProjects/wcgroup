                ...
                <div class="contact-form span7">
                    ...
                    <form method="post" action="assets/sendmail.php">
                        <label for="name" class="nameLabel">Name</label>
                          ...
                          <label for="name" class="nameLabel">Address</label>
                          <input id="name" type="text" name="name" placeholder="Enter your address...">
                          <label for="name" class="nameLabel">Contact No.</label>
                          <input id="name" type="text" name="name" placeholder="Enter your contact no...">
                        <label for="email" class="emailLabel">Email</label>
                          <input id="email" type="text" name="email" placeholder="Enter your email...">
                           <label for="email" class="emailLabel">Experiance</label>
                          <input id="email" type="text" name="email" placeholder="Enter your experiance...">
                        <label for="message" class="messageLabel">Why you want to join with us</label>
